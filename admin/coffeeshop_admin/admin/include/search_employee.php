<?php
	...
	if($searchValue != ''){
		...
		{
			$searchQuery = "AND id_role like '%$key%'";
		}
		$searchQuery = " AND (id_em like '%$searchValue%' or 
	...
	<table class="table">
                          ...
                          <th style="text-align:center;font-weight:500"> Mã nhân viên </th>
                          <th style="text-align:center;font-weight:500"> Tên nhân viên </th>
						  <th style="text-align:center;font-weight:500"> Tài khoản </th>
                          <th style="text-align:center;font-weight:500"> Email</th>
                          <th style="text-align:center;font-weight:500"> Số điện thoại</th>
                          <th style="text-align:center;font-weight:500"> Chức vụ</th>
	...
	while($row =mysqli_fetch_array($result))
	{
		...
		$output.='<tr>
									...
									<td width="10%" align="center" style="font-weight:500">
									<a href="#">
